...
/******/ 	var hotCurrentHash = "518a4c90bba761d532a8"; // eslint-disable-line no-unused-vars
...
eval("var electron = __webpack_require__(/*! electron */ \"electron\");\n\nvar app = electron.app;\nvar BrowserWindow = electron.BrowserWindow;\nvar win = null;\nprocess.env['ELECTRON_DISABLE_SECURITY_WARNINGS'] = 'true';\napp.on('ready', () => {\n  win = new BrowserWindow({\n    //transparent: true,\n    // frame: false,\n    webPreferences: {\n      nodeIntegration: true,\n      contextIsolation: false,\n      enableRemoteModule: true\n    }\n  }); // win.loadFile('index.html');\n  // win.webContents.openDevTools();\n\n  let path = __webpack_require__(/*! path */ \"path\");\n\n  let URL = __webpack_require__(/*! url */ \"url\");\n\n  let url = '';\n\n  if (true) {\n    url = 'http://localhost:' + process.env.ELECTRON_WEBPACK_WDS_PORT;\n  } else {}\n\n  win.loadURL(url);\n  win.on('closed', () => {\n    win = null;\n  });\n\n  let {\n    ipcMain\n  } = __webpack_require__(/*! electron */ \"electron\");\n\n  ipcMain.on('msg_render2main', (event, param1, param2) => {\n    console.log(param1);\n    console.log(param2);\n    win.webContents.send('msg_main2render', param1, param2); // console.log(event.sender);\n  });\n});\napp.on('window-all-closed', () => {\n  app.quit();\n});//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./src/main/index.js\n");
